...
# To view slides:
<h2>**[bookdown.org/jakevl/udwq-open-source](https://bookdown.org/jakevl/utah-dwq-open-source/){target="_blank"}**</h2>
...
## Markdown - Bookdown
Compile documents into chapters & books - document complex analyses & generate tool user guides.   

*Example:* [Utah IR R tools user guide](https://bookdown.org/jakevl/IR-R-tools-guide/)
```{r, echo=F, fig.align="center"}
knitr::include_graphics('images/bookdown_assessment.PNG')
```
...
Analyze, visualize, and write reports of water quality data in Utah waterbodies.
```{r, echo=F, fig.align="center"}
...
<h4>**Slides:**</h4>
<h4>**[bookdown.org/jakevl/udwq-open-source](https://bookdown.org/jakevl/utah-dwq-open-source/){target="_blank"}**</h4>
