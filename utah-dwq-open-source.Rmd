...
## Markdown - Bookdown
Tool for walking new R users through process of loading and running packages. 
...
[View on the DWQ Shiny apps server](https://udwq.shinyapps.io/ecoliDataExplorer/)

```{r, echo=F, fig.align="center"}
knitr::include_graphics('images/ecoli_upload.png')
```
[Source code](https://github.com/utah-dwq/tmdlTools)
